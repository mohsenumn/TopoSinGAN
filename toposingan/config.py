...
def get_arguments(seed_for_img_dir):
    ...
    parser.add_argument('--out',help='output folder',default=f'outputs/Output_{seed_for_img_dir}')
    ...
    parser.add_argument('--max_size', type=int,help='image minimal size at the coarser scale', default=1550) #250
